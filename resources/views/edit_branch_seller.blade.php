          ...
          <div class="row">
             ...
             <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{url('')}}/bseller/{{$bseller->id}}/update">
                        ...
                        <div class="col-md-8 col-lg-8">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="number" class="form-control" name="phone"  required="" value="<?= $bseller->phone ?>">
                            </div>
                             ...
                             <div class="mb-3">
                              ...
                              <input type="datetime-local" class="form-control" name="waktu_approve"   required="" value="<?= $bseller->waktu_apporve ?>">
                            </div>
                             ...
                             <select class="form-control" name="status_branch">
                                <option>{{$bseller->status_branch}}</option>
                             </select>
                            </div>
